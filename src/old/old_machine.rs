    ...
    pub fn step(&mut self) -> Result<(), ExecutionError> {
        ...
        match op {
            ...
            ECALL => {
                ...
                match self.env.syscall(
                    self.registers[Register::A7], 
                    [self.registers[Register::A0],self.registers[Register::A1],self.registers[Register::A2],self.registers[Register::A3], self.registers[Register::A4],self.registers[Register::A5]],
                    &mut self.memory) 
                {
