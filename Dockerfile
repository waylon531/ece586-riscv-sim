...
RUN cd riscv-gnu-toolchain && ./configure --prefix=/opt/riscv-cross --enable-multilib --with-multilib-generator="rv32i-ilp32--;rv32im-ilp32--;rv32imf-ilp32--" --disable-linux --disable-gdb && make -j4
